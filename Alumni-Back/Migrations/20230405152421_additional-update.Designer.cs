...
namespace AlumniBack.Migrations
{
    ...
    [Migration("20230405152421_additional-update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alumni_Back.Models.Commentary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<DateTime>("Comment_at")
            ...
            modelBuilder.Entity("Alumni_Back.Models.Like", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Alumni_Back.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Alumni_Back.Models.Commentary", b =>
                {
                    b.HasOne("Alumni_Back.Models.User", "Commentator")
                        .WithMany()
                        .HasForeignKey("CommentatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Alumni_Back.Models.Post", "Post")
                        .WithMany()
            ...
            modelBuilder.Entity("Alumni_Back.Models.Like", b =>
                {
                    b.HasOne("Alumni_Back.Models.User", "Liker")
                        .WithMany()
            ...
            modelBuilder.Entity("Alumni_Back.Models.Post", b =>
                {
                    b.HasOne("Alumni_Back.Models.User", "Publisher")
                        .WithMany()
